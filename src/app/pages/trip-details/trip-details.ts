...
@Component({
  ...
  imports: [CommonModule, RouterModule, FormsModule, LucideBus, LucideArrowRight, LucideRoute, LucideArrowLeft, LucideDownload, LucideX, LucideTrash2, LucideUserPlus, ArabicNumberPipe],
